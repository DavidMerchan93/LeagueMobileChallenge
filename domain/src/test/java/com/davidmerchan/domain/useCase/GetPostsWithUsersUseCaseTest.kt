...
class GetPostsWithUsersUseCaseTest {
    ...
    @Test
    fun `getPostsWithUsers returns combined data when both repositories succeed`() =
        runTest {
            // Given
            val posts =
                listOf(
    ...
    @Test
    fun `getPostsWithUsers returns posts without user data when user repository fails`() =
        runTest {
            // Given
            val posts =
                listOf(
    ...
    @Test
    fun `getPostsWithUsers returns empty list when post repository fails`() =
        runTest {
            // Given
            val users =
                listOf(
    ...
    @Test
    fun `getPostsWithUsers returns empty list when both repositories fail`() =
        runTest {
            // Given
            coEvery { postRepository.getPosts() } returns Result.failure(Exception("Post fetch failed"))
            coEvery { userRepository.getUsers() } returns Result.failure(Exception("User fetch failed"))
    ...
    @Test
    fun `getPostsWithUsers handles posts without matching users`() =
        runTest {
            // Given
            val posts =
                listOf(
    ...
    @Test
    fun `getPostsWithUsers handles empty posts list`() =
        runTest {
            // Given
            val users =
                listOf(
    ...
    @Test
    fun `getPostsWithUsers handles empty users list`() =
        runTest {
            // Given
            val posts =
                listOf(
    ...
    @Test
    fun `functional interface works correctly`() =
        runTest {
            // Given
            val useCase =
                GetPostsWithUsersUseCase {
                    Result.success(
                        listOf(
                            com.davidmerchan.domain.model
                                .PostWithUserModel(1, 1, "Title", "Body", "avatar.jpg", "User"),
                        ),
                    )
                }
