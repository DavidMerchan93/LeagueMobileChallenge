...
class LoginViewModelTest {
    ...
    @Test
    fun `successful login flow works correctly`() =
        runTest {
            // Given
            val authUserCase = AuthUserCase { _, _ -> Result.success(true) }
            val viewModel = LoginViewModel(authUserCase)
    ...
    @Test
    fun `failed login shows error state`() =
        runTest {
            // Given
    ...
    @Test
    fun `empty credentials show error state`() =
        runTest {
            // Given
            val authUserCase =
    ...
    @Test
    fun `multiple login attempts reset previous states`() =
        runTest {
            // Given
            val authUserCase =
                AuthUserCase { username, password ->
